...
class SearchClogType extends AbstractType
{
    /**
     * @var EccubeConfig
     */
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('c_status', ChoiceType::class, [
                'label' => 'admin.clog.c_status',
                'required' => false,
                'choices' => array(
                    "請選擇" => "",
                    "未設定"=>0,
            ...
            // "0":"未設定","3":"不在", "5":"營業中", "6":"保留中", "10":"對應済み", "11":"取消"
            ])
            ->add('c_cate', ChoiceType::class, [
                'label' => 'admin.clog.c_cate',
                'required' => false,
                'choices' => CLog::CLOG_CATEGORIES,
            ])
            /*
            ...
            ->add('prime_member', ChoiceType::class, [
                'label' => '有料會員',
                'choices' => [
                    '高级会员' => 1,
                    '轻成员' => 2,
            ...
            //salon_id 子がいる会員の(salon_idに自身の会員idを指定)売上の集計期間 20220623 kikuzawa
            ...
            ->add('payment_date_end', DateType::class, [
                'label' => 'admin.common.payment_date__end',
                'required' => false,
                'input' => 'datetime',
                'widget' => 'single_text',
                'format' => 'yyyy-MM',
