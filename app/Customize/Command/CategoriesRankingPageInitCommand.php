...
class CategoriesRankingPageInitCommand extends Command {
    protected static $defaultName = "categories:ranking:page:init";
    ...
    const PAGES = array(
        [
            ...
            'label' =>  'カテゴリから探す',
            'template'  =>  'template/default/Category/search.twig'
        ],
        [
            'name' =>  'categories_detail',
            'label' =>  'カテゴリ一覧',
            'template'  =>  'template/default/Category/detail.twig'
        ],
        [
            'name' =>  'ranking',
            'label' =>  'ランキング',
            'template'  =>  'template/default/Ranking/detail.twig'
        ]
    );
