...
class BrandPageInitCommand extends Command {
    protected static $defaultName = "brand:page:init";
    ...
    const PAGES = array(
        [
            'name' =>  'brand_index',
            'label' =>  '按品牌搜尋',
            'template'  =>  'template/default/Brand/search.twig'
        ],
        [
            'name' =>  'brand_detail',
            'label' =>  '产品列表',
            'template'  =>  'template/default/Brand/detail.twig'
        ],
    );
