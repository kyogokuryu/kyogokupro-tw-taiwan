...
class BeautySupervisorPageInitCommand extends Command
{
    protected static $defaultName = "beauty:page:init";
    ...
    const PAGES = array(
        [
            'name' =>  'beauty',
            'label' =>  '美容スーパーバイザー',
            'template'  =>  'template/default/BeautySupervisor/index.twig'
        ]
    );
