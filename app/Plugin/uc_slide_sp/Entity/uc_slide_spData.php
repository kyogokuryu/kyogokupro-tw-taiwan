 ...
 * uc_slide_spData
 *
 * @ORM\Table(name="plg_uc_slide_sp_data")
 * @ORM\Entity(repositoryClass="Plugin\uc_slide_sp\Repository\uc_slide_spDataRepository")
 */
class uc_slide_spData extends AbstractEntity
{
    /**
     * @var int
     *
