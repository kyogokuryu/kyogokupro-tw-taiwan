...
class PluginManager extends AbstractPluginManager
{
     ...
     * @var string ブロック名
     */
    private $blockName = 'UCスライドショー(スマホ)';

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName = 'uc_slide_sp_block';
    ...
    {
        $Config = $em->find(uc_slide_spConfig::class, 1);
        if ($Config) {
            return $Config;
        }

        $Config = new uc_slide_spConfig();
