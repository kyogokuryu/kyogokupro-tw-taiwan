...
class PluginManager extends AbstractPluginManager
{
    ...
    public function enable(array $meta, ContainerInterface $container)
    {
        ...
        $now = new \DateTime();
        // CSV項目登録
        $ProductItems = $entityManager->getRepository(ProductItem::class)->findAll();
    ...
    {
        $entityManager = $container->get('doctrine.orm.entity_manager');
        $Csvs = $entityManager->getRepository(Csv::class)->findBy(['entity_name' => 'Plugin\\ProductPlus\\Entity\\ProductData']);
        foreach($Csvs as $Csv){
