...
class ProductReviewType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('pic1', TextType::class,['required' => false])
            ->add('pic2', TextType::class,['required' => false])
            ->add('pic3', TextType::class,['required' => false])
            ->add('pic4', TextType::class,['required' => false])
            ;
    }
}
