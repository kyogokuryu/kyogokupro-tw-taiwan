...
namespace Plugin\uc_banner_cbd02;
...
class PluginManager extends AbstractPluginManager
{
     ...
     * @var string ブロック名
     */
    private $blockName = 'UCバナー CBD02';

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName = 'uc_banner_cbd02_block';
    ...
    {
        $Config = $em->find(uc_banner_cbd02Config::class, 1);
        if ($Config) {
            return $Config;
        }

        $Config = new uc_banner_cbd02Config();
        $Config->setTitle('UCバナー CBD02');
