...
class CouponProcessorTest extends EccubeTestCase
{
    ...
    public function testRemoveCouponDiscountItem()
    {
        ...
        $this->assertTrue($OrderItems->isEmpty(), 'プロモーションコードの明細が削除されている');
    }
    ...
    public function testProcess()
    {
        ...
        $this->assertFalse($OrderItems->isEmpty(), 'プロモーションコード明細が追加されている');
    ...
    public function testProcessWithCouponOrderIsNotFound()
    {
        ...
        $this->assertTrue($OrderItems->isEmpty(), 'プロモーションコード明細は存在しない');
    }
    ...
    public function testValidateWithNonCustomer()
    {
        ...
        try {
            ...
            $this->fail('ゲストでも使用可能なプロモーションコードであるはず');
        }
    }
