...
class OrderControllerTest extends AbstractEditControllerTestCase
{
    ...
    public function testOrderEditWithDisableCoupon()
    {
        ...
        $this->assertTrue($this->client->getResponse()->isSuccessful());
        $this->assertContains($Coupon->getCouponCd(), $crawler->html(), 'プロモーションコードが無効でも表示は変わらない');
    }
    ...
    public function testOrderEditWithDisableOrderCoupon()
    {
        ...
        $this->assertTrue($this->client->getResponse()->isSuccessful());
        $this->assertContains($Coupon->getCouponCd(), $crawler->html(), '受注プロモーションコードが無効でも表示は変わらない');
    }
    ...
    public function testOrderEditWithDeleteCoupon()
    {
        ...
        $this->assertTrue($this->client->getResponse()->isSuccessful());
        $this->assertContains($Coupon->getCouponCd(), $crawler->html(), 'プロモーションコードが削除されても表示は変わらない');
    }
    ...
    public function testOrderEditWithCouponCancel()
    {
        ...
        $this->assertContains('プロモーションコードが適用されていません', $crawler->html(), 'プロモーションコードが適用されていないメッセージ表示');
    }
