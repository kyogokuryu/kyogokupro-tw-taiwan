...
class CouponDetail extends AbstractEntity
{
     ...
     * @var float
     *
     * @ORM\Column(name="detail_discount_rate", type="decimal", nullable=true, precision=10, scale=0, options={"unsigned":true,"default":0})
     */
    private $detail_discount_rate;

    /**
     * @var bool
     *
     * @ORM\Column(name="delivery_free_flag", type="boolean", nullable=false, options={"default":true})
     */
    private $delivery_free_flag;
    ...
    /**
     * Set detail_discount_rate.
     *
     * @param string $detaildiscountrate
     *
     * @return CouponDetail
     */
    public function setDetailDiscountRate($detaildiscountrate)
    {
        $this->detail_discount_rate = $detaildiscountrate;

        return $this;
    }

    /**
     * Get detail_discount_rate.
     *
     * @return string
     */
    public function getDetailDiscountRate()
    {
        return $this->detail_discount_rate;
    }

    /**
     * Set delivery_free_flag.
     *
     * @param bool $delivery_free_flag
     *
     * @return CouponDetail
     */
    public function setDeliveryFreeFlag($delivery_free_flag)
    {
        $this->delivery_free_flag = $delivery_free_flag;

        return $this;
    }

    /**
     * Get delivery_free_flag.
     *
     * @return bool
     */
    public function getDeliveryFreeFlag()
    {
        return $this->delivery_free_flag;
    }
}
