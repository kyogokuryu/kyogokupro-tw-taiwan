...
class Coupon extends AbstractEntity
{
     ...
     * @var string
     *
     * @ORM\Column(name="coupon_memo", type="string", nullable=false, length=255)
     */
    private $coupon_memo;
     ...
     * Set coupon_memo.
     *
     * @param string $couponMemo
     *
     * @return Coupon
     */
    public function setCouponMemo($couponMemo)
    {
        $this->coupon_memo = $couponMemo;
