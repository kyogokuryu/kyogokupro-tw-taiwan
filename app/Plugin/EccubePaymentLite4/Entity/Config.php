...
class Config extends AbstractEntity
{
    ...
    const PRIME_PRODUCT_ID = 522;
    const PRIME_LIGHT_RODUCT_ID = 814;
    ...
    public function getPrimeProductId(){
        return self::PRIME_PRODUCT_ID;
    }

    public function getPrimeLightProductId(){
        return self::PRIME_LIGHT_RODUCT_ID;
    }
