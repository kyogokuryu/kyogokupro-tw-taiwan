...
class PluginManager extends AbstractPluginManager
{
    ...
    private function mailTemplateData()
    {
        return [
            [
                'クレジットカード有効期限通知メール',
                '@EccubePaymentLite4/default/Mail/expiration_notice_mail.twig',
                'ご登録されているクレジットカードの有効期限について',
            ],
            [
                '定期購入事前お知らせメール',
                '@EccubePaymentLite4/default/Mail/regular_notice_mail.twig',
                'ご購入頂いております定期購入商品についてのお知らせ',
            ],
            [
                '定期指定回数お知らせメール',
                '@EccubePaymentLite4/default/Mail/specified_count_notice_mail.twig',
                '定期購入商品継続のお礼',
            ],
        ];
    }
