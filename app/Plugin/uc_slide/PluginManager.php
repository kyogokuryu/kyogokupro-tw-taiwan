...
class PluginManager extends AbstractPluginManager
{
     ...
     * @var string ブロック名
     */
    private $blockName = 'UCスライドショー';

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName = 'uc_slide_block';
    ...
    {
        $Config = $em->find(uc_slideConfig::class, 1);
        if ($Config) {
            return $Config;
        }

        $Config = new uc_slideConfig();
