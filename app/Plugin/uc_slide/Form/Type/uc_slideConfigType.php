...
namespace Plugin\uc_slide\Form\Type;
...
class uc_slideConfigType extends AbstractType
{
    /**
     * @var EccubeConfig
     */
    ...
    /**
     * uc_slideConfigType constructor.
     *
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('slide_type', ChoiceType::class, [
            ...
            'choices' => array_flip([
                ...
                '2' => trans('admin.common.choiceType.thumbnail'),
            ]),
            'expanded' => false,
            'multiple' => false,
            'placeholder' => false,
