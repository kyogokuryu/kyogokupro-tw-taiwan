...
class MailMagazineSendHistory extends AbstractEntity
{
    ...
    /**
     * @ORM\Column(name="send_schedule", type="datetime", nullable=true)
     *
     * @var \DateTime
     */
    private $send_schedule;

    /**
     * @ORM\Column(name="`status`", type="smallint", nullable=false, options={"unsigned": true, "default": 1})
     *
     * @var int
     */
    private $status;
     ...
     * Set send_schedule.
     *
     * @param \DateTime $sendSchedule
     *
     * @return MailMagazineSendHistory
     */
    public function setSendSchedule($sendSchedule)
    {
        $this->send_schedule = $sendSchedule;
     ...
     * @return \DateTime
     */
    public function getSendSchedule()
    {
        return $this->send_schedule;
    }
