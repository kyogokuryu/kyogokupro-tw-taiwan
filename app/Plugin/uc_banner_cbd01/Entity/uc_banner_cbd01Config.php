...
namespace Plugin\uc_banner_cbd01\Entity;

use Doctrine\ORM\Mapping as ORM;
use Eccube\Entity\AbstractEntity;

/**
 * uc_banner_cbd01Config
 *
 * @ORM\Table(name="plg_uc_banner_cbd01")
 * @ORM\Entity(repositoryClass="Plugin\uc_banner_cbd01\Repository\uc_banner_cbd01ConfigRepository")
 */
class uc_banner_cbd01Config extends AbstractEntity
{
    /**
     * @var int
     *
