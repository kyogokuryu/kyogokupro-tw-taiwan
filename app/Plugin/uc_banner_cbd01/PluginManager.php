...
namespace Plugin\uc_banner_cbd01;
...
class PluginManager extends AbstractPluginManager
{
     ...
     * @var string ブロック名
     */
    private $blockName = 'UCバナー CBD01';

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName = 'uc_banner_cbd01_block';
    ...
    {
        $Config = $em->find(uc_banner_cbd01Config::class, 1);
        if ($Config) {
            return $Config;
        }

        $Config = new uc_banner_cbd01Config();
        $Config->setTitle('UCバナー CBD01');
