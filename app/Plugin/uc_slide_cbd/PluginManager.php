...
class PluginManager extends AbstractPluginManager
{
     ...
     * @var string ブロック名
     */
    private $blockName = 'UCスライドショー CBD';

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName = 'uc_slide_cbd_block';
    ...
    {
        $Config = $em->find(uc_slide_cbdConfig::class, 1);
        if ($Config) {
            return $Config;
        }

        $Config = new uc_slide_cbdConfig();
