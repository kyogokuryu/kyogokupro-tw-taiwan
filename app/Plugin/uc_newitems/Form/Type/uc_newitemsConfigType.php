...
namespace Plugin\uc_newitems\Form\Type;
...
class uc_newitemsConfigType extends AbstractType
{
    /**
     * @var EccubeConfig
     */
    ...
    */
    ...
    /**
     * uc_newitemsConfigType constructor.
     *
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('tag_id', ChoiceType::class, [
            'label' => 'タグ',
            'choices' => array_flip($this->getTagList()),
            'expanded' => false,
            'multiple' => false,
            'placeholder' => false,
            'constraints' => [
    ...
    {
        $Tags = $this->containerInterface->get(TagRepository::class)->findAll();
