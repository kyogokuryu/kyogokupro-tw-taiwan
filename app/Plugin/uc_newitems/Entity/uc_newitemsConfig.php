...
namespace Plugin\uc_newitems\Entity;
 ...
 * uc_newitemsConfig
 *
 * @ORM\Table(name="plg_uc_newitems")
 * @ORM\Entity(repositoryClass="Plugin\uc_newitems\Repository\uc_newitemsConfigRepository")
 */
class uc_newitemsConfig extends AbstractEntity
{
    /**
     * @var int
     *
