 ...
 * uc_bannerData
 *
 * @ORM\Table(name="plg_uc_banner_data")
 * @ORM\Entity(repositoryClass="Plugin\uc_banner\Repository\uc_bannerDataRepository")
 */
class uc_bannerData extends AbstractEntity
{
    /**
     * @var int
     *
