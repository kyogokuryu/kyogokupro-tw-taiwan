...
namespace Plugin\PinpointSale\Service\PlgConfigService\Entity;
...
trait ConfigTrait
{
     ...
     *
     * @ORM\OneToMany(targetEntity="Plugin\PinpointSale\Entity\PlgConfigOption", mappedBy="PlgConfig", cascade={"persist", "remove"})
     */
