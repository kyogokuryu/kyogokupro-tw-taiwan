...
namespace Plugin\PinpointSale\Service\PlgConfigService\DoctrineMigrations;


use Doctrine\ORM\OptimisticLockException;
use Doctrine\ORM\ORMException;
use Plugin\PinpointSale\Service\PlgConfigService\ConfigMigrationService;
use Plugin\PinpointSale\Service\PlgConfigService\Utils\ConfigServiceUtils;

/**
 * Trait ConfigMigrationTrait
 * @package Plugin\PinpointSale\Service\PlgConfigService\DoctrineMigrations
 *
 */
trait ConfigMigrationTrait
{
