...
use Customize\Entity\PointLog;
    ...
    {
    use \Plugin\MailMagazine4\Entity\CustomerTrait, \Customize\Entity\CustomerTrait, \Plugin\GmoPaymentGateway4\Entity\CustomerTrait, \Plugin\Stripe4\Entity\CustomerTrait;
    ...
    /**
         ...
         *
         * @ORM\OneToMany(targetEntity="Eccube\Entity\Video", mappedBy="customer")
         * @ORM\JoinColumns({
         *   @ORM\JoinColumn(name="id", referencedColumnName="customer_id")
         * })
         */
        private $videoWatchPoints;

        /**
         * @var \Customize\Entity\PointLog
         *
         * @ORM\OneToMany(targetEntity="\Customize\Entity\PointLog", mappedBy="customer" ,cascade={"persist"})
         * @ORM\JoinColumns({
         *   @ORM\JoinColumn(name="id", referencedColumnName="customer_id")
         * })
         */
        ...
        /**
         * @var \Customize\Entity\AccessLog
         *
         * @ORM\OneToMany(targetEntity="\Customize\Entity\AccessLog", mappedBy="customer" ,cascade={"persist"})
         * @ORM\JoinColumns({
         ...
         */
        private $enter_supplier_code_date;

        /**
         * @ORM\Column(type="string", length=255, options={"default":"kgfa"})
         */
        private $supplier_code = 'buzz';
        ...
        public function __construct()
        {
            ...
            $this->PointLogs = new \Doctrine\Common\Collections\ArrayCollection();
            // $this->AccessLogs = new \Doctrine\Common\Collections\ArrayCollection();
        ...
        public function isBuyReady():bool
        {
            return $this->addr01 !== null;
        }
        ...
        /**
         * Set video_watch_point.
         *
         * @param \Eccube\Entity\VideoWatchPoint $videoWatchPoints
         *
         */
        public function addVideoWatchPoints(VideoWatchPoint $videoWatchPoints)
        {
        ...
        /**
         * Get video_watch_point.
         *
         * @return \Eccube\Entity\VideoWatchPoint
         */
        ...
        public function removeVideoWatchPoint($videoWatchPoints)
        {
         ...
         * Set point_log.
         *
         * @param \Customize\Entity\PointLog $PointLog
         *
         */
        ...
        public function setPoint($point)
        {
            ...
            if($this->getId()){
                $dbt = debug_backtrace();
            //    $args = isset($dbt[1]["args"]) ? implode(",", $dbt[1]["args"]) : "";
                $trace = sprintf('%s:%s@%s()', $dbt[1]["file"], $dbt[1]["line"], $dbt[1]["function"]);
                //log_info(sprintf("[UserLog %s] point %s -> %s : trace:%s", $this->getId(), $this->point, $point, $trace));
                //$trace = "";
                log_info("[Point Log]", [sprintf("Customer Id %s] point %s -> %s : trace:%s", $this->getId(), $this->point, $point, $trace) ]);

                $point_log = new PointLog;
                $point_log->setCustomerId($this->getId());
                $point_log->setPoint1($this->point);
                $point_log->setPoint2($point);
                $point_log->setMemo($trace);
                $this->addPointLog($point_log);
            }
        ...
        public function getEnterSupplierCodeDate(): ?\DateTimeInterface
        {
            return $this->enter_supplier_code_date;
        }

        public function setEnterSupplierCodeDate(?\DateTimeInterface $enter_supplier_code_date): self
        {
            $this->enter_supplier_code_date = $enter_supplier_code_date;
