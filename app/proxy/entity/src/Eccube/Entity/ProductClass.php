...
use Doctrine\ORM\Mapping as ORM;
    ...
    {
    use \Plugin\PinpointSale\Entity\ProductClassTrait, \Plugin\KokokaraSelect\Entity\ProductClassTrait;
    ...
    private $price01_inc_tax = null;
         ...
         * @var boolean
         *
         * @ORM\Column(name="delivery_fee_free", type="boolean", options={"default":false})
         */
        public $delivery_fee_free = false;
