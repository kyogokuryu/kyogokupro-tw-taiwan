...
// 2020.06.10 update
         ...
         * @var string
         *
         * @ORM\Column(name="out_pdf_1", type="string", length=255, nullable=true)
         */
        private $out_pdf_1;
         ...
         * @var string
         *
         * @ORM\Column(name="out_pdf_2", type="string", length=255, nullable=true)
         */
        private $out_pdf_2;
         ...
         * @var string
         *
         * @ORM\Column(name="out_pdf_3", type="string", length=255, nullable=true)
         */
        private $out_pdf_3;
// 2020.06.10 update
...
// 2020.06.10 update
         ...
         * Set OutPdf1
         *
         * @param string $out_pdf_1
         *
         * @return Shipping
         */
        public function setOutPdf1($out_pdf_1)
        {
            $this->out_pdf_1 = $out_pdf_1;
         ...
         * @return string
         */
        public function getOutPdf1()
        {
            return $this->out_pdf_1;
        }

        /**
         * Set OutPdf2
         *
         * @param string $out_pdf_2
         *
         * @return Shipping
         */
        public function setOutPdf2($out_pdf_2)
        {
            $this->out_pdf_2 = $out_pdf_2;
         ...
         * @return string
         */
        public function getOutPdf2()
        {
            return $this->out_pdf_2;
        }

        /**
         * Set OutPdf3
         *
         * @param string $out_pdf_3
         *
         * @return Shipping
         */
        public function setOutPdf3($out_pdf_3)
        {
            $this->out_pdf_3 = $out_pdf_3;
         ...
         * @return string
         */
        public function getOutPdf3()
        {
            return $this->out_pdf_3;
        }
// 2020.06.10 update
    }
