...
use Doctrine\ORM\Mapping as ORM;
    ...
    {
    use \Plugin\BundleSale4\Entity\ProductTrait, \Plugin\ApgRichEditor\Entity\ProductTrait, \Plugin\RelatedProduct4\Entity\ProductTrait, \Plugin\Collection\Entity\Extension\ProductTrait, \Plugin\ProductPlus\Entity\ProductTrait, \Plugin\SheebDlc\Entity\ProductTrait, \Customize\Entity\ProductTrait, \Plugin\ProductOption\Entity\ProductTrait, \Plugin\KokokaraSelect\Entity\ProductTrait;
    ...
    private $_calc = false;
        ...
        /**
         * @var \Customize\Entity\Brand
         *
         * @ORM\ManyToOne(targetEntity="Customize\Entity\Brand", inversedBy="products")
         * @ORM\JoinColumns({
        ...
        /**
         * @ORM\Column(name="llmo_target_audience", type="text", nullable=true)
         */
        private $llmo_target_audience;

        /**
         * @ORM\Column(name="llmo_problem_solution", type="text", nullable=true)
         */
        private $llmo_problem_solution;

        /**
         * @ORM\Column(name="llmo_usage_scene", type="text", nullable=true)
         */
        private $llmo_usage_scene;

        /**
         * @ORM\Column(name="llmo_supervised_comment", type="text", nullable=true)
         */
        private $llmo_supervised_comment;

        /**
         * @ORM\Column(name="llmo_how_to_use", type="text", nullable=true)
         */
        private $llmo_how_to_use;

        /**
         * @ORM\Column(name="llmo_features", type="text", nullable=true)
         */
        private $llmo_features;

        /**
         * @ORM\Column(name="llmo_faq", type="text", nullable=true)
         */
        private $llmo_faq;
         ...
         * Set brand id.
         *
         * @param \Customize\Entity\Brand $brand
         *
         * @return Product
         */
        public function setBrand(\Customize\Entity\Brand $brand)
        {
            $this->brand = $brand;
         ...
         * Get brand id.
         *
         * @return \Customize\Entity\Brand|null
         */
        ...
        public function getLlmoTargetAudience()
        {
            return $this->llmo_target_audience;
        }
        public function setLlmoTargetAudience($llmo_target_audience)
        {
            $this->llmo_target_audience = $llmo_target_audience;

            return $this;
        }
        public function getLlmoProblemSolution()
        {
            return $this->llmo_problem_solution;
        }
        public function setLlmoProblemSolution($llmo_problem_solution)
        {
            $this->llmo_problem_solution = $llmo_problem_solution;

            return $this;
        }
        public function getLlmoUsageScene()
        {
            return $this->llmo_usage_scene;
        }
        public function setLlmoUsageScene($llmo_usage_scene)
        {
            $this->llmo_usage_scene = $llmo_usage_scene;

            return $this;
        }
        public function getLlmoSupervisedComment()
        {
            return $this->llmo_supervised_comment;
        }
        public function setLlmoSupervisedComment($llmo_supervised_comment)
        {
            $this->llmo_supervised_comment = $llmo_supervised_comment;

            return $this;
        }
        public function getLlmoHowToUse()
        {
            return $this->llmo_how_to_use;
        }
        public function setLlmoHowToUse($llmo_how_to_use)
        {
            $this->llmo_how_to_use = $llmo_how_to_use;

            return $this;
        }
        public function getLlmoFeatures()
        {
            return $this->llmo_features;
        }
        public function setLlmoFeatures($llmo_features)
        {
            $this->llmo_features = $llmo_features;

            return $this;
        }
        public function getLlmoFaq()
        {
            return $this->llmo_faq;
        }
        public function setLlmoFaq($llmo_faq)
        {
            $this->llmo_faq = $llmo_faq;
