...
final class EccubeEvents
{
  ...
  /**
     * Admin/Product/BrandController
     */
    // index
    const ADMIN_PRODUCT_BRAND_INDEX_INITIALIZE = 'admin.product.brand.index.initialize';
    const ADMIN_PRODUCT_BRAND_INDEX_COMPLETE = 'admin.product.brand.index.complete';
    // delete
    const ADMIN_PRODUCT_BRAND_DELETE_COMPLETE = 'admin.product.brand.delete.complete';
    /**
