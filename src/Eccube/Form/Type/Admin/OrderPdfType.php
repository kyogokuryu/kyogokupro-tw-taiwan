...
class OrderPdfType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('title', /*TextType::class, [*/ChoiceType::class, [
                // 'required' => false,
                ...
                // ],
                'choices' => [
                    'admin.order.delivery_note_title__default' => 1,
                    'admin.order.delivery_note_title__default2' => 2,
                    'admin.order.delivery_note_title__default3' => 3,
                ],
                'expanded' => false,
                'multiple' => false,
                'required' => false,
