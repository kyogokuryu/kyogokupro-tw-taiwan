...
if (!class_exists('\Eccube\Entity\BaseInfo')) {
    ...
    class BaseInfo extends \Eccube\Entity\AbstractEntity
    {
         ...
         * @var string|null
         *
         * @ORM\Column(name="mlog_password", type="string", length=255)
         */
        private $mlog_password;
         ...
         * Set mlogPassword.
         *
         * @param string|null $mlogPassword
         *
         * @return BaseInfo
         */
         public function setMlogPassword($mlogPassword = null)
         {
             $this->mlog_password = $mlogPassword;
          ...
          * @return string|null
          */
         public function getMlogPassword()
         {
             return $this->mlog_password;
         }
    }
}
