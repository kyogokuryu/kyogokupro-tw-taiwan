...
if (!class_exists('\Eccube\Entity\Product')) {
    ...
    class Product extends \Eccube\Entity\AbstractEntity
    {
         ...
         *
         * @ORM\OneToOne(targetEntity="Eccube\Entity\VideoRelativeProduct", mappedBy="product")
         * @ORM\JoinColumns({
         *   @ORM\JoinColumn(name="id", referencedColumnName="product_id")
         * })
         */
        private $videoRelativeProducts;
         ...
         * Set brand.
         *
         * @param \Customize\Entity\Brand|null
         *
         * @return Product
         */
        public function setBrand(\Customize\Entity\Brand $brand = null)
        {
            $this->brand = $brand;
         ...
         * Set status.
         *
         * @param \Eccube\Entity\Video $video
         *
         * @return Product
         */
        public function setVideoRelativeProducts(VideoRelativeProduct $videoRelativeProducts)
        {
            $this->videoRelativeProducts = $videoRelativeProducts;
         ...
         * Get status.
         *
         * @return \Eccube\Entity\VideoRelativeProduct
         */
