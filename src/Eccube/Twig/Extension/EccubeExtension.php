...
class EccubeExtension extends AbstractExtension
{
    ...
    public function getFunctions()
    {
        return [
            ...
            new TwigFunction('f_last_customer_order', [$this, 'f_last_customer_order']),
    ...
    public function getFilters()
    {
        return [
            ...
            new TwigFilter('price', [$this, 'getPriceFilter'], ['is_safe' => ['html']]),
    ...
    public function getPriceFilter($number, $decimals = 0, $decPoint = '.', $thousandsSep = ',')
    {
        ...
        $formattedPrice = str_replace('NT$', 'TWD$ ', $formattedNumber);
    ...
    public function f_last_customer_order($productId) {
        $lastOrderCustomers = $this->productRepository->getCustomerLastOrder($productId);
        $mails = null;
